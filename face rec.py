...
detectFace = mp.solutions.face_detection.FaceDetection(min_detection_confidence=0.38)
...
while True:
    ...
    if results.detections != None:
        for face in results.detections:
            ...
            if probabilityValue * 100 <= 50:
                cv2.rectangle(img, (x1, y1), (x2, y2), (80, 255, 0), 2)
                cv2.rectangle(img, (x1, y1 - 40), (x2, y1), (80, 255, 0), -2)
                cv2.putText(img, str("Unknown"), (x1, y1 - 10), font, 0.75, (255, 255, 255), 1, cv2.LINE_AA)
